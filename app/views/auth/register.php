...
<section id="register" class="container my-5 px-6 mx-auto" aria-label="Register Section">
  <div class="mb-32 text-gray-800">
    ...
    <div class="container w-full flex justify-center text-gray-800 px-4 md:px-12">
      <div class="w-8/12 block rounded-lg shadow-lg py-10 md:py-12 px-4 md:px-6" style="margin-top:50px; background: hsla(0, 0%, 100%, 0.8); backdrop-filter: blur(30px);">
        <div class="max-w-lg mx-auto">
          ...
          <div class="text-center">
            <p class="m-4 text-sm" aria-label="">
              ...
              <a href="/auth/login" class="inline-block text-violet-500 font-medium text-xs leading-tight underline hover:text-violet-700">
                Login Here</a>.
            </p>
          </div>
